                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="left">
                                                                    <!--[if mso]>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://lpkprimabuanaindonesia.com" style="height:46px;width:195px;v-text-anchor:middle;" arcsize="35%" stroke="false" fillcolor="#506bec">
<w:anchorlock/>
<v:textbox inset="5px,0px,0px,0px">
<center dir="false" style="color:#ffffff;font-family:Arial, sans-serif;font-size:15px">
<!
                                                                        [endif]--><a
                                                                        href="https://lpkprimabuanaindonesia.com"
                                                                        target="_blank"
                                                                        style="
                                                                            ...
                                                                            style="
                                                                                ...
                                                                                style="
                                                                                    ...
                                                                                    style="
                                                                                            ...
                                                                                            line-height: 30px;
                                                                                        "
                                                                                    data-mce-style><strong>KUNJUNGI
                                                                                        WEBSITE</strong></span></span></span></a>><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
...
<body>
    <div class="container">
        <div class="header">
            <h1>LPK Prima Buana Indonesia</h1>
        </div>
        <div class="content text-center">
            <h2>Terimakasih sudah mengisi formulir</h2>
            <p>Silahkan menunggu untuk tahap validasi data.</p>
            <a href="{{ url('https://lpkprimabuanaindonesia.com') }}" class="btn btn-primary">Kembali ke Situs</a>
        </div>
        <div class="footer">
            <p>
                &copy; {{ date('Y') }} LPK Prima Buana Indonesia. All rights
                reserved.
            </p>
        </div>
    </div>
